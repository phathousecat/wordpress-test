...
// *************************
//  Stylesheets/Page Titles
// *************************
function stylesheet_scripts() {
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '3.3.6' );
	wp_enqueue_style( 'blog', get_template_directory_uri() . '/css/style.css' );
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), '3.3.6', true );
}

add_action( 'wp_enqueue_scripts', 'stylesheet_scripts' );
...
//  Global Config & Menu
// **********************
// Custom settings (social media links etc.)
function profile_settings_add_menu() {
  add_menu_page( 'Profile Settings', 'Profile Settings', 'manage_options', 'custom-settings', 'global_profile_settings', null, 99 );
}
add_action( 'admin_menu', 'profile_settings_add_menu' );

// Create Global Profile Settings
function global_profile_settings() { ?>
  <div class="wrap">
...
// YouTube
function set_youtube_url() { ?>
  <input type="text" name="twitter" id="twitter" value="<?php echo get_option( 'youtube' ); ?>" />
<?php }

// Instagram
function set_instagram_url() { ?>
  <input type="text" name="twitter" id="twitter" value="<?php echo get_option( 'instagram' ); ?>" />
<?php }
...
function upload_about_image( ) { ?>
  ...
  <?php print $meta; ?>
	<div class="image-preview"><img src="<?php echo get_option( 'about_img' ); ?>" style="max-width: 250px;"></div>
  <script>
